...
(defn install
  ...
  (bundle/add-directory manifest "otter/lib/device")
  (bundle/add-directory manifest "otter/lib/ui")
  (bundle/add-directory manifest "otter/lib/input")
  ...
  (bundle/add manifest "lib/device.janet" "otter/lib/device.janet")
  (bundle/add manifest "lib/device/desktop.janet" "otter/lib/device/desktop.janet")
  (bundle/add manifest "lib/device/kobo.janet" "otter/lib/device/kobo.janet")
  (bundle/add manifest "lib/paint.janet" "otter/lib/paint.janet")
  (bundle/add manifest "lib/skia.janet" "otter/lib/skia.janet")
  (bundle/add manifest "lib/input.janet" "otter/lib/input.janet")
  (bundle/add manifest "lib/input/constants.janet" "otter/lib/input/constants.janet")
  (bundle/add manifest "lib/input/raw.janet" "otter/lib/input/raw.janet")
  (bundle/add manifest "lib/input/normalize.janet" "otter/lib/input/normalize.janet")
  ...
  (bundle/add manifest "lib/ui/size.janet" "otter/lib/ui/size.janet")
  (bundle/add manifest "lib/ui/stack.janet" "otter/lib/ui/stack.janet")
  (bundle/add manifest "lib/ui/svg.janet" "otter/lib/ui/svg.janet")
  (bundle/add manifest "lib/ui/translate.janet" "otter/lib/ui/translate.janet")
  (bundle/add manifest "lib/ui/with-context.janet" "otter/lib/ui/with-context.janet")
  ...
  (bundle/add manifest "lib/demo/otter-dance-frame.png" "otter/lib/demo/otter-dance-frame.png")
  (bundle/add manifest "lib/demo/otter-mark.svg" "otter/lib/demo/otter-mark.svg")
